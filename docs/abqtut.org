...
The file [[https://github.com/Nidish96/Abaqus4Joints/blob/main/assets/assembly/model_step0.cae][model_step0.cae]] stores the CAE file at the end of the above steps (building parts, and partitioning).
...
4. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/scripts/c_nutwasherbolt_516.py][c_nutwasherbolt_516.py]]: Building the bolt, nut, and washer models.
