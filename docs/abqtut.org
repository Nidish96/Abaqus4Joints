...
The file [[../assets/assembly/model_step0.cae]] stores the CAE file at the end of the above steps (building parts, & partitioning).
...
The file [[../assets/assembly/model_step1.cae]] stores the CAE-file generated after the end of the above steps.
...
The file [[../assets/assembly/model_step1.cae]] stores the CAE-file along with the mesh.
...
The file [[../assets/assembly/model_step2.cae]] is the cae file containing the model with the above tests included.
* Postprocessing
...
The file [[../assets/assembly/model_step3.cae]] is the final cae file that contains all of the above.
