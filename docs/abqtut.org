...
9. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/assets/demo/main_rc.m][main_rc.m]]: Contains the MATLAB/OCTAVE file for the nonlinear static prestress analysis using the relative coordinates representation. 
