...
4. If your model passes all the above, then you are ready to proceed.
   *INCLUDE NOTE ABOUT MESH CONVERGENCE?*
...
** Simple Analysis on MATLAB/OCTAVE                                 :Script:
...
3. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/scripts/b_halfbm.py][b\under{}halfbm.py]]: Building the half-beam model
4. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/scripts/c_nutwasherbolt_516.py][c\under{}nutwasherbolt\under{}516.py]]: Building the bolt, nut, and washer models.
5. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/scripts/d_applyconstraints.py][d\under{}applyconstraints.py]]: Applying the relevant constraints and introducing bolt prestress.
6. [[https://github.com/Nidish96/Abaqus4Joints/blob/main/scripts/e_nodeproc.py][e\under{}nodeproc.py]]: The postprocessing script create surface node sets and setting up substructure analysis.
