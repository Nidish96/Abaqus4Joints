...
3. Create a Reference Point Part called =REFPT=.
   ...
   #+end_src
4. Now import the nuts, washers and bolts by importing the file [[../scripts/c_nutwasherbolt_516.py]].
...
1. [[../scripts/a_steelmat.py]]: Loading material
2. [[../scripts/b_halfbm.py]]: Building the half-beam model
3. [[../scripts/c_nutwasherbolt_516.py]]: Building the bolt, nut, & washer models.
4. [[../scripts/d_applyconstraints.py]]: Applying the relevant constraints and introducing bolt prestress.
5. [[../scripts/e_nodeproc.py]]: The postprocessing script create surface node sets and setting up substructure analysis.
6. [[../scripts/readwritematvec.sh]]: Contains the mtx reading script written with =bash= and =python=.
