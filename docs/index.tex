...
\caption{\label{fig:org28df3a2}Geometry of the BRB Benchmark}
\end{figure}

A picture of the parts of the BRB is shown in Fig. \ref{fig:org28df3a2} and this will be used to guide the modeling here.
Standard 5/16 bolt-nut-washers will be used for the assembly. Since Bolt thread interactions won't be modeled here, the bolt shank is modeled as a smooth cylinder (see \ref{org8f377e2} for more details on bolt prestress modeling).
...
\item Fig \ref{fig:org075e7ce} shows a pictorial overview of the different options available in ABAQUS for scripting support. The ABAQUS PDE can be used for ABAQUS python script development.
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./figs/ovw.png}
\caption{\label{fig:org075e7ce}Options in ABAQUS for Scripting}
\end{figure}

\subsection{Modeling Parts\hfill{}\textsc{Script:GUI}}
\label{sec:orgad5891e}
...
This will be necessary for the application of bolt prestress (see \ref{org8f377e2} below).
\begin{verbatim}
...
These two points will have to be on the same geometrical point but equal and opposite forces will be applied for the force application (see \ref{org8f377e2} below for those steps).
...
\begin{center}
\includegraphics[width=\textwidth]{../assets/demo/quadpts.png}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{../assets/demo/intdisps.png}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{../assets/demo/intpress.png}
\end{center}
\end{enumerate}
\subsubsection{Miscellanies}
\label{sec:org0838896}
\begin{enumerate}
